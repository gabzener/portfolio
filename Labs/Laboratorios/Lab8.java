...
class Lab8{
    ...
    public static int sumaElementosAux(int[] arr, int i) {
        if (i == arr.length)
            return 0;
        else
            return arr[i] + sumaElementosAux(arr, i + 1);
    }

    public static int sumaElementos(int[] nums) {
        return sumaElementosAux(nums, 0);
    }
